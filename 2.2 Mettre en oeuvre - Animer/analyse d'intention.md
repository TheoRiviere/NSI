# Analyse d'intention de la découverte d'une application web
...
## Exercices cibles :
Cette activité prépare des exercices ultérieurs sur les mécanismes de congestion réseau, les files d'attente, la qualité de service (QoS), ou plus largement sur la nécessité des protocoles réseau (TCP/IP)
...
- Deuxième partie : faire plusieurs parties (15 min par partie)

- Troisième partie : Débriefing et mise en lien avec les réseaux informatiques

## Anticipation des difficultés des élèves :

Certains élèves peuvent se focaliser sur une logique de « victoire individuelle » alors que le jeu n'a de sens que collectivement


## Gestion de l'hétérogénéïté :
Activité découverte, pas blocant pour la suite.
