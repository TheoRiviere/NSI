...
Le travail qui est présenté s'inscrit dans le choix (bien évidemment discutable) de la progressivité suivante :
- Pile
- File
...
La séquence commence avec un corpus d'activités sur les piles :
...
Le questionnnement de "la meilleur implémentation" est construit tout au long de l'année en interrogeant la complexité en opérations des fonctions construites en Python.

Activité 1 : Implémentation avec la list Python - image mentale contigue des données
A joindre

Activité 2 : Implémentation avec un tableau surdimenssionné - image mentale contigue des données
A joindre x

Activité 3 : Implémentation avec le principe de chaînage - image mentale éparpillée des données
A joindre
